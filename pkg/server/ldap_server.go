...
func (ldapServer *LDAPServer) handleSearch(w ldap.ResponseWriter, m *ldap.Message) {
	...
	e.AddAttribute("mail", "test@bing.com", "test@bing.com")
	e.AddAttribute("company", "bing")
	e.AddAttribute("department", "bing")
	e.AddAttribute("l", "bing")
	e.AddAttribute("mobile", "13000000000")
	e.AddAttribute("telephoneNumber", "13000000000")
	e.AddAttribute("cn", "bing")
	w.Write(e)
